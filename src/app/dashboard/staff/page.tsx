          ...
          <div className="rounded-[26px] border border-white/10 bg-white/5 p-5 backdrop-blur">
            <div className="mb-6 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-white/70">Staff Dashboard</p>
              </div>
            </div>
  ...
  return (
    <div className="space-y-5 pb-4">
      ...
      <Panel
        ...
        subtitle="Barangay 19-B support operations overview"
      >
        <div className="grid items-start gap-4 md:grid-cols-4">
      ...
      >
        <div className="mb-5 flex items-center gap-4 rounded-2xl border border-[#BFDBFE] bg-[#EFF6FF] p-5">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500">Health Center Staff</p>
          </div>
        </div>
