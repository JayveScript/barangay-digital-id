          ...
          <div className="rounded-[26px] border border-white/10 bg-white/5 p-5 backdrop-blur">
            <div className="mb-6 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-white/70">BHW Dashboard</p>
              </div>
            </div>
  ...
  return (
    <div className="space-y-5 pb-4">
      ...
      <Panel
        ...
        subtitle="Barangay 19-B resident monitoring overview"
      >
        <div className="grid items-start gap-4 md:grid-cols-4">
  ...
  return (
    <div className="space-y-5 pb-4">
      <Panel
        ...
        subtitle="Your BHW account details"
      >
        <div className="mb-5 flex items-center gap-4 rounded-2xl border border-[#BFDBFE] bg-[#EFF6FF] p-5">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500">Barangay Health Worker</p>
          </div>
        </div>
        ...
        <div className="grid items-start gap-4 md:grid-cols-2 xl:grid-cols-3">
          ...
          <InfoBox label="Barangay" value={user.barangay?.name || "Barangay 19-B"} />
